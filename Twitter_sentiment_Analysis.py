...
model = RandomForestClassifier(n_estimators=300, max_depth=30, min_samples_split=5, min_samples_leaf=2, 
                               random_state=42, class_weight="balanced_subsample", bootstrap=True)  # Enable bootstrapping
...
print(dataset['Sentiment'].value_counts(normalize=True))  # Show percentage distribution
